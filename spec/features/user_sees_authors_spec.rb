...
describe 'author index' do
  ...
  it 'user can top rated view for authors book' do
    ...
    author_1 = Author.create(name: "Author_1")
    book = author_1.books.create(title: "Title 1", pages: 100, year:2000)
    review1 = user1.reviews.create(title: "Review 1", description: "description 1", score: 3, user_id: user1.id)
    review2 = user2.reviews.create(title: "Review 2", description: "description 2", score: 4, user_id: user2.id)
